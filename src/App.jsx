...
const CIE10_DATABASE = [
  ...
  // --- CAPÍTULO XIII: ENFERMEDADES DEL SISTEMA OSTEOMUSCULAR Y CONJUNTIVO (M00-M99) ---
  ...
  { code: "M50.1", description: "TRASTORNO DE DISCO CERVICAL CON RADICULOPATIA" },

  { code: "M51.1", description: "TRASTORNOS DE DISCO INTERVERTEBRAL LUMBAR CON RADICULOPATIA" },

  { code: "M40.0", description: "CIFOSIS POSTURAL" },

  { code: "M41.9", description: "ESCOLIOSIS, NO ESPECIFICADA" },

  { code: "M43.1", description: "ESPONDILOLISTESIS" },
  ...
  { code: "M75.2", description: "TENDINITIS BICI_PITAL" },

  { code: "M77.0", description: "EPICONDILITIS MEDIAL (CODO DE GOLFISTA)" },

  { code: "M77.1", description: "EPICONDILITIS LATERAL (CODO DE TENISTA)" },

  { code: "M76.5", description: "TENDINITIS ROTULIANA" },

  { code: "M76.6", description: "TENDINITIS DEL TENDON DE AQUILES" },
  ...
  { code: "G80.0", description: "PARALISIS CEREBRAL ESPASTICA CUADRIPLEGICA" },

  { code: "G80.1", description: "PARALISIS CEREBRAL ESPASTICA DIPLEGICA" },

  { code: "G80.2", description: "PARALISIS CEREBRAL ESPASTICA HEMIPLEGICA" },

  { code: "G82.2", description: "PARAPLEJIA NO ESPECIFICADA" },

  { code: "G82.5", description: "CUADRIPLEJIA NO ESPECIFICADA" },

  { code: "G35", description: "ESCLEROSIS MULTIPLE" },

  { code: "G12.2", description: "ENFERMEDAD DE LAS NEURONAS MOTORAS (ELA, PARALISIS BULBAR)" },

  { code: "G24.3", description: "TORTICOLIS ESPASMODICA" },



  // --- CAPÍTULO XIX: TRAUMATISMOS Y SECUELAS (S00-T98) ---

  { code: "S82.8", description: "FRACTURA DE OTRAS PARTES DE LA PIERNA (MALEOLO/TO_BILLO)" },

  { code: "S83.5", description: "ESGUINCE O DESGARRO DE LIGAMENTOS CRUZADOS DE LA RODILLA" },

  { code: "S33.5", description: "ESGUINCE Y TORCEDURA DE LA COLUMNA LUMBAR" },

  { code: "S43.4", description: "ESGUINCE Y TORCEDURA DE LA ARTICULACION DEL HOMBRO" },

  { code: "T90.5", description: "SECUELAS DE TRAUMATISMO INTRACRANEAL" },

  { code: "T91.1", description: "SECUELAS DE FRACTURA DE LA COLUMNA VERTEBRAL" },

  { code: "T91.3", description: "SECUELAS DE TRAUMATISMO DE LA MEDULA ESPINAL" },

  { code: "T92.2", description: "SECUELAS DE FRACTURA DE LA MUÑECA Y DE LA MANO" },

  { code: "T93.2", description: "SECUELAS DE OTRAS FRACTURAS DE MIEMBRO INFERIOR (PIERNA/TO_BILLO)" },



  // --- CAPÍTULO IX: ENFERMEDADES DEL SISTEMA CIRCULATORIO (I00-I99) ---

  { code: "I69.4", description: "SECUELAS DE ACCIDENTE CEREBROVASCULAR (ACV) NO ESPECIFICADO" },

  { code: "I69.3", description: "SECUELAS DE INFARTO CEREBRAL" },
  ...
  { code: "R26.8", description: "OTRAS ANORMALIDADES DE LA MARCHA Y DE LA MOVILIDAD" },

  { code: "R29.0", description: "TETANIA" },

  { code: "R52.1", description: "DOLOR CRONICO INTRATABLE" },
